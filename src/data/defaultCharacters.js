...
export const defaultCharacters = [
  ...
  },
  {
    ...
    prompt: 'The selected character, Trisha Krishnan, is the main subject of the cinematic scene. She stands on a breathtaking mountain peak during a golden sunrise, surrounded by glowing clouds, volumetric sun rays, and distant soaring eagles. Keep the selected character’s appearance, face, hairstyle, clothing, and proportions highly consistent throughout the entire video. She looks naturally toward the sunrise with subtle realistic facial expressions and gentle movement. Her hair and clothing move naturally in the mountain breeze. Start with a wide establishing shot and smoothly transition into a medium close-up of the character. Photorealistic, cinematic composition, natural lighting, realistic motion, atmospheric depth, 4K quality.',
    imagePrompt: 'Start with a wide establishing shot of Trisha Krishnan on the mountain summit at golden sunrise, transitioning smoothly into an intimate medium close-up portrait with hair and fabric fluttering naturally in the mountain breeze.',
    isDefault: true
  },
  {
